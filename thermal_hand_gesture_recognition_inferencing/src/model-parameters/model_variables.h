...
const char* ei_classifier_inferencing_categories[] = { "Paper", "Rock", "Scissor", "Unknown" };
...
const uint32_t ei_learning_block_9_inputs[1] = { 7 };
...
const ei_impulse_t impulse_306094_0 = {
    .project_id = 306094,
    ...
    .visual_ad_grid_size_x = int((32 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((32 / 8) / 2 - 1),
...
ei_impulse_handle_t impulse_handle_306094_0 = ei_impulse_handle_t( &impulse_306094_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_306094_0;
